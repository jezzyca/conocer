<%-- 
    Document   : reportesCertificados
    Created on : 9/01/2025, 06:47:16 PM
    Author     : Conocer
--%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ page import="java.util.*, org.json.JSONObject, org.json.JSONArray" %>
<%@ page import="reportes.ReportesCertificados" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<jsp:useBean id="ReportesCertificados" class="reportes.ReportesCertificados" scope="page" />
        ...
        <div class="row align-items-center">
            ...
            <div class="col-6 d-flex justify-content-center align-items-center">
                ...
                <select name="procedimientos" id="seleccion" class="form-select w-50">
                    ...
                    <option value="2">Certificados Emitidos</option>
                    <option value="3">Cifras de Acreditación</option>
                    <option value="4">Cintillos EC</option>
                    <option value="5">Determinación de la Procedencia de las Solicitudes de Certificados Anual</option>
                    <option value="6">Determinación de la Procedencia de las Solicitudes de Certificados Ultimos Dias</option>
                    <option value="7">Directorio ENLACES</option>
                    <option value="8">Instituciones Acreditadas</option>
                    <option value="9">Instituciones Acreditadas Básico</option>
                    <option value="10">Instituciones Educativas</option>
                    <option value="11">Logos ECE / OC</option>
                    <option value="12">Lotes de Certificados</option>
                    <option value="13">Reporte de Acreditación CE / EI</option>
                    <option value="14">Reporte de Acreditaciónes ECE / OC</option>
                    <option value="15">Reporte de Empresas</option>
                    <option value="16">Reporte de Renovaciónes CE / EI</option>
                    <option value="17">Reporte de Renovaciónes ECE / OC</option>
                    <option value="18">Reporte Integral</option>
                    <option value="19">Sector Productivo</option>
                    <option value="20">Soluciones de Evaluación y Certificaciónes EC</option>
                    <option value="21">Verificadores EC / ECE / OC</option>
                </select>
...
const reportTitles = {
    ...
    "2": "Reporte de Certificados Emitidos",
    "3": "Reporte de Cifras de Acreditación",
    "4": "Reporte de Cintillos EC",
    "5": "Reporte de Determinación de la Procedencia de las Solicitudes de Certificados Anual",
    "6": "Reporte de Determinación de la Procedencia de las Solicitudes de Certificados Ultimos Dias",
    "7": "Reporte de Directorio ENLACES",
    "8": "Reporte de Instituciones Acreditadas",
    "9": "Reporte de Instituciones Acreditadas Básico",
    "10": "Reporte de Instituciones Educativas",
    "11": "Reporte de Logos ECE / OC",
...
const columnOrderMap = {
    ...
    "12": ["Fecha de recepción", "Folio solicitud certificación", "Código EC", "Total procesos", "Nivel EC", "Total de fichas", "Clave ECE/OC"],  
    "13": ["Cédula ECE/OC", "Razón Social ECE/OC", "Cédula CE/EI", "Nombre Completo Razón Social CE", "Código", "Título EC", "Fecha Final Vigencia", "Estado", "Entidad Federativa"], 
    "14": ["No. Solicitud Acred. EC/OC", "Cédula", "Siglas", "Razón Social", "Estandar de Competencia", "Titulo del Estandar", "Vigencia Inicial", "Vigencia Final", "Estado", "Entidad Federativa"], 
    "15": ["Nombre Institución", "Domicilio", "Colonia", "Delegación/Municipio", "Código postal", "Estado", "Teléfono", "Correo electrónico", "Página web", "Giro", "Nombre director general", "Sucursales", "Años de operación", "Total trabajadores/empleados", "Número de trabajadores/empleados susceptibles de certificación", "Asociaciones/Cámaras", "Funciones/EC"],
    "16": ["Cédula ECE/OC", "Nombre ECE/OC", "Cédula CE/EI", "Nombre CE/EI", "Código", "Título", "Inicio vigencia", "Fin vigencia", "Fecha de Ultima Renovacion"], 
    "17": ["Cédula", "Nombre", "Código", "Título", "Inicio vigencia", "Fin Vigencia", "Tipo acreditación"], //revisar
    "18": ["Cédula Certificador", "Nombre", "Operativo", "Total E.C."], 
    "19": ["Sector", "Código estándar", "Titulo estándar", "Siglas certificador", "Cédula certificador", "ECE", "OC", "Nombre certificador", "Total Certificados"],
    "20": ["NOMBRE ECE/OC", "TIPO PRESTADOR SERVICIOS", "NOMBRE CENTRO EVALUADOR", "CODIGO EC", "TITULO EC", "ESTATUS ECE/OC", "ESTATUS CE"], 
    "21": ["Cédula", "Siglas", "Nombre", "Código", "Vigencia Acreditacion", "Título", "CURP", "Nombre Verificador", "Estatus"],
};
