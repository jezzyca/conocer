<%-- 
    Document   : reportesSector
    Created on : 23/12/2024, 11:17:53 AM
    Author     : Conocer
--%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ page import="java.util.*, org.json.JSONObject, org.json.JSONArray" %>
<%@ page import="reportes.ReportesSector" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<jsp:useBean id="ReportesSector" class="reportes.ReportesSector" scope="page" />
        ...
        <div class="row align-items-center">
            ...
            <div class="col-6 d-flex justify-content-center align-items-center">
                ...
                <select name="procedimientos" id="seleccion" class="form-select w-50">
                    ...
                    <option value="1">Total de usuarios</option>
                    <option value="2">Usuarios por Categoría</option>
                    <option value="3">Usuarios por Curso</option>
                    <option value="4">Usuarios por Sector</option> 
                </select>
...
function descargarReporte() {
    ...
    fetch('ReporteSelector?' + params.toString(), {
        method: 'GET',
        credentials: 'same-origin',
        headers: {
