<%-- 
    Document   : certificadosMarca
    Created on : 23/12/2024, 11:17:53 AM
    Author     : Conocer
--%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ page import="java.util.*, org.json.JSONObject, org.json.JSONArray" %>
<%@ page import="reportes.CertificadosMarca" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<jsp:useBean id="CertificadosMarca" class="reportes.CertificadosMarca" scope="page" />
...
function realizarBusqueda() {
    ...
    const params = new URLSearchParams({
        ...
        page: 1,
        pageSize: 100, // Para obtener todos los resultados de la búsqueda
        fullSearch: 'true'
    });
    ...
    if (searchTerm) {
        ...
        params.append('allRecords', 'true'); // Para obtener todos los registros que coincidan
    }

    fetch('CertificadosMarca?' + params.toString(), {
        method: 'GET',
        headers: { 
...
const reportTitles = {
    ...
    "2": "Reporte de Certificados de Marca por ECE / OC",
...
const columnOrderMap = {
    ...
    "2": ["ELEMENTO", "REGISTROS"],
    "3": ["ELEMENTO", "REGISTROS"],
