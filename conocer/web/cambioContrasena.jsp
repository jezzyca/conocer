    ...
    <nav class="navbar navbar-expand-lg bg-white shadow-sm">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                <img src="img/userpersona.png" alt="Usuario" class="rounded-circle me-2" width="40">
                <div class="text-end">
                    <h6 class="mb-0 small">Usuario: <c:out value="${sessionScope.usuario}" /></h6>
                    <small class="text-muted">Fecha: <c:out value="${sessionScope.fecha}" /></small>
                </div>
            </div>
        </div>
    </nav>
