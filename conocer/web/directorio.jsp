...
const reportTitles = {
    "1": "Reporte de Acreditaciones EC/OCE",
    "2": "Reporte de Directorio CE / EI"
};
...
const columnOrderMap = {
    "1": ["No. Solicitud Acred. EC/OC", "Cédula", "Siglas", "Razón Social", "Estandar de Competencia", "Titulo del Estandar", "Vigencia Inicial", "Vigencia Final", "Estado", "Entidad Federativa"], 
    "2": ["Cedula ECE/OC", "Nombre ECE/OC", "Cedula CE/EI", "Nombre CE/EI", "Direccion", "Colonia", "Codigo Postal", "Localidad", "Municipio", "Estado", "Representante", "Correo Representante", "Telefono Representante", "Contacto 1", "Correo Contacto 1", "Telefono Contacto 1", "Contacto 2", "Correo Contacto 2", "Telefono Contacto 2", "Estandares", "Vigencia"],
};
...
function descargarReporte() {
    ...
    const validOptions = ["1", "2"]; // Lista de opciones válidas
    ...
    const nombreReporte = {
        "1": "Reporte_de_Acreditaciones_EC_OC",
        "2": "Reporte_de_Directorio_CEEI"
    };
