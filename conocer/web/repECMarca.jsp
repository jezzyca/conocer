...
const reportTitles = {
    "1": "Certificados de Marca con Totales",
...
const columnOrderMap = {
    "1": ["CONVENIO","ENTIDAD","NOMBRE","CUENTA"],
...
function descargarReporte() {
    ...
    const nombreReporte = {
        "1": "Certificados_de_Marca_con_Totales",
        "2": "Certificados_de_Marca_por_EC_OCE",
        "3": "Certificados_de_Marca_por_Estado",
    };
