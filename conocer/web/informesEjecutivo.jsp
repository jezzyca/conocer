...
const reportTitles = {
    "1": "Reporte de Estándares de Competencia",
    "2": "Reporte de Informe Ejecutivo CGC",
...
const columnOrderMap = {
    "1": ["Código EC","Nombre Proyecto de EC","Título EC","Nombre del CGC","Fecha de Publicación DOF", "Vigencia del certificado", "Nivel EC", "Versión EC", "EC Activo", "Instrumento Activo", "Tipo de EC"],
    "2": ["Agrupación", "Nombre del C.G.C.", "Fecha Aprobación COVACEC", "Fecha de Ratificación", "Estado C.G.C.", "Activo"],
    "3": ["No. Instrumento de Evaluación", "Código Estándar de Competencia", "Título EC", "Activo","Versión Actual", "Instrumento Activo", "Terminado", "Fecha Publicación DOF", "Edo. Desarrollo EC"],
    "4": ["Nombre Institución", "Domicilio", "Colonia", "Delegación/Municipio", "Código postal", "Estado", "Teléfono", "Correo electrónico", "Página web", "Afiliacion organismo/unión/feredación", "Nombre presidente/secretario", "Secciones", "Total trabajadores/empleados", "Número de trabajadores/empleados susceptibles de certificación", "Funciones/EC"], 
    "5": ["Nombre Institución", "Domicilio", "Colonia", "Delegación/Municipio", "Código postal", "Estado", "Teléfono", "Correo electrónico", "Página web", "Ámbito de competencia", "Antigüedad", "Nombre director general/presidente", "No. Organizaciones filiales", "Total trabajadores/empleados", "Número de trabajadores/empleados susceptibles de certificación", "Asociaciones/Cámaras", "Funciones/EC"], 
};
